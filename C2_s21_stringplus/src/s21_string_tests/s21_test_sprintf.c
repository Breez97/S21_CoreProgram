...
//   ck_assert_int_eq(
//       s21_sprintf(str1, "%lc%lc", (long unsigned int)'A', (long unsigned
//       int)'b'), sprintf(str2, "%lc%lc", (long unsigned int)'A', (long
//       unsigned int)'b'));
...
START_TEST(test_sprintf25) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, "%.f", 121.123),
                   sprintf(str2, "%.f", 121.123));
...
START_TEST(g_one_zero) {
  ...
  char str2[BUFF_SIZE];
  char format[] = "%g";
  double hex = 0.11111111111111111;
  ck_assert_int_eq(s21_sprintf(str1, format, hex), sprintf(str2, format, hex));
...
Suite *suite_sprintf(void) {
  ...
  tcase_add_test(tests, simple_int);
  tcase_add_test(tests, precise_int);
  tcase_add_test(tests, width_int);
  tcase_add_test(tests, minus_width_int);
  tcase_add_test(tests, plus_width_int);
  tcase_add_test(tests, padding_int);
  tcase_add_test(tests, star_width_int);
  tcase_add_test(tests, star_precision_int);
  tcase_add_test(tests, many_flags_many_ints);
  tcase_add_test(tests, flags_long_int);
  tcase_add_test(tests, flags_short_int);
  tcase_add_test(tests, flags_another_long_int);
  tcase_add_test(tests, zero_precision_zero_int);
  tcase_add_test(tests, space_flag_int);
  tcase_add_test(tests, unsigned_val);
  tcase_add_test(tests, unsigned_val_width);
  tcase_add_test(tests, unsigned_val_flags);
  tcase_add_test(tests, unsigned_val_precision);
  tcase_add_test(tests, unsigned_val_many_flags);
  tcase_add_test(tests, unsigned_val_short);
  tcase_add_test(tests, unsigned_val_long);
  tcase_add_test(tests, unsigned_val_many);
  tcase_add_test(tests, octal);
  tcase_add_test(tests, octal_width);
  tcase_add_test(tests, octal_flags);
  tcase_add_test(tests, octal_precision);
  tcase_add_test(tests, octal_many_flags);
  tcase_add_test(tests, octal_short);
  tcase_add_test(tests, octal_long);
  tcase_add_test(tests, octal_many);
  tcase_add_test(tests, octal_zero);
  tcase_add_test(tests, octal_hash);
  tcase_add_test(tests, unsigned_zero);
  tcase_add_test(tests, hex_width);
  tcase_add_test(tests, hex_flags);
  tcase_add_test(tests, hex_precision);
  tcase_add_test(tests, hex_many);
  tcase_add_test(tests, hex_many_flags);
  tcase_add_test(tests, hex_zero);
  tcase_add_test(tests, hex_huge);
  tcase_add_test(tests, hex_short);
  tcase_add_test(tests, hex_long);
  tcase_add_test(tests, hex_one_longer_width);
  tcase_add_test(tests, hex_two_longer_width);
  tcase_add_test(tests, one_char);
  tcase_add_test(tests, one_precision);
  tcase_add_test(tests, one_flags);
  tcase_add_test(tests, one_width);
  tcase_add_test(tests, one_many);
  tcase_add_test(tests, one_many_flags);
  tcase_add_test(tests, string);
  tcase_add_test(tests, string_precision);
  tcase_add_test(tests, string_width);
  tcase_add_test(tests, string_flags);
  tcase_add_test(tests, string_long);
  tcase_add_test(tests, string_many);
  tcase_add_test(tests, ptr);
  tcase_add_test(tests, ptr_width);
  tcase_add_test(tests, ptr_precision);
  tcase_add_test(tests, null_ptr);
  tcase_add_test(tests, n_specifier);
  tcase_add_test(tests, string_width_huge);
  tcase_add_test(tests, float_precision);
  tcase_add_test(tests, float_width);
  tcase_add_test(tests, float_precision_zero);
  tcase_add_test(tests, float_precision_empty);
  tcase_add_test(tests, float_precision_huge);
  tcase_add_test(tests, float_precision_huge_negative);
  tcase_add_test(tests, float_huge);
  tcase_add_test(tests, float_flags);
  tcase_add_test(tests, float_many);
  tcase_add_test(tests, e_precision);
  tcase_add_test(tests, e_precision_zero);
  tcase_add_test(tests, e_precision_empty);
  tcase_add_test(tests, e_precision_huge);
  tcase_add_test(tests, e_precision_huge_negative);
  tcase_add_test(tests, e_huge);
  tcase_add_test(tests, e_many);
  tcase_add_test(tests, e_width);
  tcase_add_test(tests, e_flags);
  tcase_add_test(tests, E_int);
  tcase_add_test(tests, all_empty);
  tcase_add_test(tests, empty_format_and_parameters);
  tcase_add_test(tests, test_one_char);
  tcase_add_test(tests, test_many_char);
  // tcase_add_test(tests, test_lc);
  tcase_add_test(tests, test_one_string);
  tcase_add_test(tests, test_many_string);
  tcase_add_test(tests, test_one_dec);
  tcase_add_test(tests, test_many_dec);
  tcase_add_test(tests, test_one_int);
  tcase_add_test(tests, test_many_int);
  tcase_add_test(tests, test_one_float);
  tcase_add_test(tests, test_many_float);
  tcase_add_test(tests, test_one_unsigned_dec);
  tcase_add_test(tests, test_many_unsigned_dec);
  tcase_add_test(tests, test_one_char_with_alignment_left);
  tcase_add_test(tests, test_one_char_with_alignment_right);
  tcase_add_test(tests, test_many_char_with_alignment);
  tcase_add_test(tests, test_one_hex_lower);
  tcase_add_test(tests, test_one_hex_upper);
  tcase_add_test(tests, test_many_hex_lower);
  tcase_add_test(tests, test_many_hex_upper);
  tcase_add_test(tests, test_one_hex_lower_with_alignment_left);
  tcase_add_test(tests, test_one_hex_lower_with_alignment_right);
  tcase_add_test(tests, test_one_hex_upper_with_alignment_left);
  tcase_add_test(tests, test_one_hex_upper_with_alignment_right);
  tcase_add_test(tests, test_many_hex_lower_with_alignment);
  tcase_add_test(tests, test_many_hex_upper_with_alignment);
  tcase_add_test(tests, test_one_hex_with_hashtag);
  tcase_add_test(tests, test_one_hex_upper_with_hashtag);
  tcase_add_test(tests, test_many_hex_lower_with_hashtag_and_alignm);
  tcase_add_test(tests, test_many_hex_upper_with_hashtag_and_alignm);
  tcase_add_test(tests, test_one_hex_lower_with_width_star);
  tcase_add_test(tests, test_one_hex_upper_with_width_star);
  tcase_add_test(tests,
                 test_many_hex_lower_with_width_star_and_align_and_hashtag);
  tcase_add_test(tests, test_many_hex_upper_with_width_star);
  tcase_add_test(tests, test_one_hex_lower_with_precision);
  tcase_add_test(tests, test_one_hex_upper_with_precision);
  tcase_add_test(tests, test_many_hex_lower_with_precision_and_other);
  tcase_add_test(tests, test_many_hex_upper_with_precision_and_other);
  tcase_add_test(tests, test_one_hex_lower_with_length);
  tcase_add_test(tests, test_one_hex_upper_with_length);
  tcase_add_test(tests, test_sprintf1);
  tcase_add_test(tests, test_sprintf2);
  tcase_add_test(tests, test_sprintf3);
  tcase_add_test(tests, test_sprintf4);
  tcase_add_test(tests, test_sprintf6);
  tcase_add_test(tests, test_sprintf7);
  tcase_add_test(tests, test_sprintf8);
  tcase_add_test(tests, test_sprintf9);
  tcase_add_test(tests, test_sprintf10);
  tcase_add_test(tests, test_sprintf11);
  // tcase_add_test(tests, test_sprintf12);
  tcase_add_test(tests, test_sprintf14);
  tcase_add_test(tests, test_sprintf15);
  tcase_add_test(tests, test_sprintf16);
  tcase_add_test(tests, test_sprintf17);
  tcase_add_test(tests, test_sprintf18);
  tcase_add_test(tests, test_sprintf19);
  tcase_add_test(tests, test_sprintf20);
  tcase_add_test(tests, test_sprintf24);
  tcase_add_test(tests, test_sprintf25);
  tcase_add_test(tests, test_sprintf28);
  tcase_add_test(tests, test_sprintf29);
  tcase_add_test(tests, test_sprintf30);
  tcase_add_test(tests, test_sprintf31);
  tcase_add_test(tests, test_sprintf32);
  tcase_add_test(tests, test_sprintf33);
  tcase_add_test(tests, test_sprintf35);
  tcase_add_test(tests, test_sprintf36);
  tcase_add_test(tests, test_sprintf37);
  tcase_add_test(tests, test_sprintf38);
  tcase_add_test(tests, test_sprintf39);
  tcase_add_test(tests, test_sprintf40);
  tcase_add_test(tests, test_sprintf41);
  tcase_add_test(tests, test_sprintf42);
  tcase_add_test(tests, test_sprintf43);
  tcase_add_test(tests, test_sprintf44);
  tcase_add_test(tests, test_sprintf26);
  tcase_add_test(tests, test_sprintf27);
  tcase_add_test(tests, g_trailing_zero);
  tcase_add_test(tests, g_large);
  tcase_add_test(tests, g_small);
  tcase_add_test(tests, g_precision);
  tcase_add_test(tests, g_precision_zero);
  tcase_add_test(tests, g_precision_missing);
  tcase_add_test(tests, g_many_zeroes_in_front);
  tcase_add_test(tests, g_one_zero);
  // tcase_add_test(tests, g_mantiss);
  // tcase_add_test(tests, g_mantiss_flags);
  tcase_add_test(tests, g_short_no_mantiss);
  tcase_add_test(tests, LG);
  tcase_add_test(tests, g_many);
  tcase_add_test(tests, g_zero);
